...
CREATE TABLE `carro` (
  ...
  KEY `fk_id_modelo` (`fk_id_modelo`),
  KEY `fk_id_usuario` (`fk_id_usuario`),
  CONSTRAINT `carro_ibfk_1` FOREIGN KEY (`fk_id_modelo`) REFERENCES `modelo` (`id_modelo`),
  CONSTRAINT `carro_ibfk_2` FOREIGN KEY (`fk_id_usuario`) REFERENCES `usuario` (`id_usuario`)
